...
<html lang="en">
  <head>
    ...
    <title>The Finer Years: Update Confirmation</title>
  </head>
  <body>
    <!-- EMAIL -->
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table align="center" style="width:95%; margin:0 auto 0 auto;">
                                          <tr>
                                            <td style="padding:5px; vertical-align:top;">The information for the community below has been recently updated.</td>
                                          </tr>
                                        </table>
                                        ...
                                        <table align="center" style="width:95%; margin:0 auto 0 auto;">
                                          ...
                                          <tr style="background-color:#EEEEEE;">
                                            <td style="font-weight:bold; width:90px; padding:5px; vertical-align:top;">Community Description:</td>
                                            <td style="padding:5px; vertical-align:top;">{{$community['enhanced_intro_text']}}</td>
                                          </tr>
                                          <tr>
                                            <td style="font-weight:bold; width:90px; padding:5px; vertical-align:top;">Photo Gallery:</td>
                                            <td style="padding:5px; vertical-align:top;">
                                              @if ($community['isApproved'] 
                                                && $community['isEnhanced']
                                                
                                              )
                                                <a href="{{$community['enhancedViewURL']}}">View enhanced page</a>
                                              @else
                                                (pending approval)
                                              @endif
                                            </td>
                                          ...
                                          <tr style="background-color:#EEEEEE;">
                                            <td style="font-weight:bold; width:90px; padding:5px; vertical-align:top;">Amenities:</td>
                                            <td style="padding:5px; vertical-align:top;">
                                              @if (is_array($community['amenities']))
                                                @foreach ($community['amenities'] as $key => $amenity)
                                                  {{ $amenity['name'] }}@if ( $key <  count($community['amenities'])-1 ),@endif
                                                @endforeach
                                              @endif                                              
                                            </td>
                                          </tr>
