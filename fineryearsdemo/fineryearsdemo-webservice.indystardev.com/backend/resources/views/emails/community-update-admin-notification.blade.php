...
<html lang="en">
  <head>
    ...
    <title>The Finer Years: Update Admin Notification</title>
  </head>
  <body >
    <!-- EMAIL -->
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table align="center" style="width:95%; margin:0 auto 0 auto;">
                                          <tr>
                                            <td style="padding:5px; vertical-align:top; word-break:break-all;">An enhanced listing as updated. Please review the submission at: <a href="{{$cmslink}}">{{$cmslink}}</a>.</td>
                                          </tr>
                                        </table>
                                        ...
                                        <table align="center" style="width:95%; margin:0 auto 0 auto;">
                                          ...
                                          <tr>
                                            ...
                                            <td style="padding:5px; vertical-align:top;">View enhanced page</td>
                                          </tr>
                                          <tr style="background-color:#EEEEEE;">
                                            <td style="font-weight:bold; width:90px; padding:5px; vertical-align:top;">Amenities:</td>
                                            <td style="padding:5px; vertical-align:top;">Item 1, Item 2, Item 3</td>
                                          </tr>
                                          <tr>
