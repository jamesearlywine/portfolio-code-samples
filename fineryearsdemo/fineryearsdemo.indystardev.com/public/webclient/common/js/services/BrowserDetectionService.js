 ...
 * (ugly, should be refactored to execute 
 *  in service instantiation - see bottom of page);
 ****************************************************/
...
window.isChrome = !(window.chrome === undefined);
window.isChromeIOS = (navigator.userAgent.indexOf('CriOS') !== -1);
window.isIOS = checkIOS();
...
/****************************************************
 * Browser / Device Detection 
 * exposed as angular service
 ****************************************************/

angular.module('BrowserDetectionService', [])
  .factory('BrowserDetectionService', [
    function() {
      return {
